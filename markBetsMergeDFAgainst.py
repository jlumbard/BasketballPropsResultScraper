...
for i, row in df.iterrows():
    ...
    if(df.at[i,'designation'] == df.at[i,'away']):
        df.at[i,'teamMergeColumn'] = df.at[i,'home']
    elif(df.at[i,'designation'] == df.at[i,'home']):
        df.at[i,'teamMergeColumn'] = df.at[i,'away']
...
mergedSocialsDFNoProps.to_csv('mergedSocialsDFNoPropsAgainst.csv')
...
mergedSocialsDFAgg.merge(socialMediaDF,how="inner",left_on="teamMergeColumn",right_on="TEAM").to_csv('mergedSocialsDFAggAgainstUnderdogs.csv')